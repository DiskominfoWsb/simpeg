...
class browser extends uploader {
    ...
    public function __construct() {
        parent::__construct();
        require_once "lib/helper_dir.php";
        require_once "lib/helper_file.php";
        require_once "lib/helper_httpCache.php";
        require_once "lib/helper_path.php";
        require_once "core/types/type_img.php";
        require_once "core/types/type_mime.php";
        require_once "lib/class_gd.php";
        require_once "lib/class_input.php";
        require_once "lib/class_zipFolder.php";
