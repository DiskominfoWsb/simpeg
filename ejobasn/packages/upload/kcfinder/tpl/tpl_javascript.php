...
browser.lang = "<?php echo jsValue($this->lang) ?>";
browser.type = "<?php echo jsValue($this->type) ?>";
browser.theme = "<?php echo jsValue($this->config['theme']) ?>";
browser.access = <?php echo json_encode($this->config['access']) ?>;
browser.dir = "<?php echo jsValue($this->session['dir']) ?>";
browser.uploadURL = "<?php echo jsValue($this->config['uploadURL']) ?>";
browser.thumbsURL = browser.uploadURL + "/<?php echo jsValue($this->config['thumbsDir']) ?>";
<?php IF (isset($this->get['opener']) && strlen($this->get['opener'])): ?>
browser.opener.name = "<?php echo jsValue($this->get['opener']) ?>";
<?php ENDIF ?>
...
<?php ENDIF ?>
browser.cms = "<?php echo jsValue($this->cms) ?>";
_.kuki.domain = "<?php echo jsValue($this->config['cookieDomain']) ?>";
_.kuki.path = "<?php echo jsValue($this->config['cookiePath']) ?>";
_.kuki.prefix = "<?php echo jsValue($this->config['cookiePrefix']) ?>";
