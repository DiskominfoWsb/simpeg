...
@if(count($rs) > 0)
{!! Form::open(array('url' => url('').'/eformasi/petajabatan/savejabfungum', 'method' => 'POST', 'class'=>'form-horizontal form-'.\Config::get('claravel::ajax'),'id'=>'form-jabfungum')) !!}
        ...
        $('#add_btn').click(function (e) {
            ...
            $('#idjenjab'+nomor).on('change',function(e){
                ...
                if($this.val() == 2){
                    ...
                    autoComplete('#idjabatan'+nomor, '{{url('')}}/eformasi/petajabatan/jabfung', '.: Pilihan :.', null, '', '', '');
                } else if ($this.val() == 3){
                    $('#jabatan'+nomor).html('<select id="idjabatan'+nomor+'" name="idjabatan[]" class="form-control"></select>');
                    autoComplete('#idjabatan'+nomor, '{{url('')}}/eformasi/petajabatan/jabfungum', '.: Pilihan :.', null, '', '', '');
                } else {
                ...
                $('#idjabatan'+nomor).on('change',function(e){
                    ...
                    if($('#idjenjab'+nomor).val() == 3){
                        var urlpendidikan = '{!!url('')!!}/eformasi/petajabatan/tkpendidjur';
                    } else if($('#idjenjab'+nomor).val() == 2){
                        var urlpendidikan = '{!!url('')!!}/eformasi/petajabatan/tkpendidjurfung';
                    }
