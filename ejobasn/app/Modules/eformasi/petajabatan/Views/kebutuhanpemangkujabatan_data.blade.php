<?php
    ...
    $where = ' tb_01.idjenkedudupeg not in ("99","21") and tb_01.idskpd like "'.$idskpd.'%" and tb_01.nip not in (select banyakorang from '.config('global.kepegawaian').'.pemangkujabatanopd where idskpd like "'.$idskpd.'%" and periode_bulan = "'.$periode_bulan.'" and periode_tahun = "'.$periode_tahun.'")';
