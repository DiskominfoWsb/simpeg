<section class="content-header">
        <h1>
            Buat Peta Jabatan Baru<small></small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="{!!url('')!!}"> Dashboard</a></li>
            <li><a href="#" id="back"> Peta Jabatan</a></li>
            <li class="active">Buat Peta Jabatan Baru</li>
        </ol>
    </section>
        ...
        <div class="box box-primary">
            <div class="row">
                <div class="col-md-12">
                    ...
                    {!! Form::open(array('url' => \Request::path(), 'method' => 'POST', 'class'=>'form-horizontal form-'.\Config::get('claravel::ajax'),'id'=>'form-petajabatan')) !!}
                    <div class="box-body">
                        <div class="form-group">
                            {!! Form::label('periode', 'Periode:', array('class' => 'col-sm-3 control-label')) !!}
                            <div class="col-sm-7">
                                <div class="row">
                                    <div class="col-md-6">{!! comboBulan("periode_bulan",date('m'),"") !!}</div>
                                    <div class="col-md-6">{!! comboTahun("periode_tahun",date('Y'),"") !!}</div>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="box-footer">
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-7">
                                <button class="btn btn-success" type="button" id="prev-petajabatan"><i class="fa fa-list-ul"></i> Lihat Jabatan Struktural Sementara</button>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $('#form-petajabatan').on('submit',function(e){
                var $this = $(this);
                e.preventDefault();
            ...
            $('#prev-petajabatan').on('click', function(e){
                ...
                $.ajax({
                    type: 'post',
                    url : '{!!url('')!!}/eformasi/petajabatan/data/petajabatanprev',
