...
?>
    <table class="table table-striped table-hover table-condensed table-bordered" id="tabel">
        ...
        <tr>
            ...
            <td>:</td>
            <td>{!!($rs->syarat_idtkpendid!='')? PetajabatanModel::getJenisPendidikan($rs->syarat_idtkpendid):'-'!!}</td>
            
        </tr>
        <tr>
            <td style="padding-left:26px;">- Jurusan</td>
            <td>:</td>
            <td>{!!($rs->syarat_idjenjurusan!='')? PetajabatanModel::getJenisjurusan($rs->syarat_idjenjurusan):'-'!!}</td>
        </tr>
        <tr>
            <td style="padding-left:26px;">- Diklat</td>
            <td>:</td>
            <td>{!!($rs->syarat_iddiklat!='')? PetajabatanModel::getSyaratdiklat($rs->syarat_iddiklat,$rs->idjenjab):'-'!!}</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>:</td>
            <td>{!!($rs->syarat_iddiklat!='')? PetajabatanModel::getKebutuhandiklat($rs->id):'-'!!}</td>
        </tr>
