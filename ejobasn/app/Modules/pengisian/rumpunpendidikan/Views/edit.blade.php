...
<section class="content-header">
    <h1>
        Edit Rumpun Pendidikan<small></small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="{!!url('')!!}"> Dashboard</a></li>
        <li><a href="#" id="back"> Rumpun Pendidikan</a></li>
        <li class="active">Edit Rumpun Pendidikan</li>
    </ol>
</section>
<section class="content">
  <div class="box box-success">
    ...
    <div class="row">
      <div class="col-md-12">
        {!! Form::model($rumpunpendidikan, array('url' => $uri, 'method' => 'POST', 'class'=>'form-horizontal form-'.\Config::get('claravel::ajax') ,'id'=>'simpan')) !!}
        {!! Form::hidden('idrumpunpendid') !!}
        <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        {!! comboTkpendidikanMulti($id="idtkpendid[]",$rumpunpendidikan->idtkpendid,$required="multiple") !!}
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        {!! comboJenjurusanMulti($id="idjenjurusan[]",$rumpunpendidikan->idjenjurusan,$required="multiple") !!}
                    </div>
                </div>
