<section class="content-header">
    <h1>
        Edit Uploadgambar<small></small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="{!!url()!!}"> Dashboard</a></li>
        <li><a href="#" id="back"> Uploadgambar</a></li>
        <li class="active">Edit Uploadgambar</li>
    </ol>
</section>
<section class="content">
  <div class="box box-primary">
    ...
    <div class="row">
      <div class="col-md-8">
        {!! Form::model($uploadgambar, array('url' => $uri, 'method' => 'POST', 'class'=>'form-horizontal form-'.\Config::get('claravel::ajax') ,'id'=>'simpan')) !!}
        {!! Form::hidden('id') !!}
        <div class="box-body">
				...
				<div class="form-group">				
					...
					<div class="col-sm-7">				
						<img width="150px" src="{{url()}}/packages/upload/gambar/{!!($uploadgambar->gambar=='')?'images.png':$uploadgambar->gambar!!}"/>				
					</div>				
				</div>	
				<div class="form-group">
