<?php
    ...
    $rs = \DB::table('tr_petajab')
            ...
            ->select(\DB::raw('tr_petajab.*, a_matkulpel.matkulpel, a_tugasdokter.tugasdokter,a_jabfung.isguru as fungisguru,a_jabfungum.isguru as pelisguru, skpd.skpd as subskpd'),
			//\DB::raw(concat('tr_petajab.namajabatan,' ', a_matkulpel.matkulpel)) as namajabatan1'),
