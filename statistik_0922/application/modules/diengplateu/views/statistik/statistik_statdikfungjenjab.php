<script>
    $(document).ready(function(){
        $('#tb-statistik .link').click(function(){
            ...
            var vidjabfungum = $(par).find('.ed1').html();
            ...
            $('#form-print #idjabfungum').val(vidjabfungum);
...
<form id="form-print" name="form-print" action="<?=base_url()?>diengplateu/page/statistik_statdikfungjenjab_print" class="form-horizontal" method="post" enctype="multipart/form-data" target="_blank">
    <input type="hidden" id="idwhere" name="idwhere" value="" />
    <input type="hidden" id="idjenkel" name="idjenkel" value="" />
    <input type="hidden" id="idjabfungum" name="idjabfungum" value="" />
        ...
        <table class="table table-hover table-bordered" width="100%" id="tb-statistik">
            <thead>
                <tr>
                    ...
                    <th><div align="center">Jabatan Fungsional Umum</div></th>
            ...
            <?php
                ...
                $rs = $this->db->query("SELECT a.jabfungum as kategori, a.idjabfungum, SUM(IF(b.idjabfungum!='' AND b.idjenkel = 1,1,0)) AS jmlpria, SUM(IF(b.idjabfungum!='' AND b.idjenkel = 2,1,0)) AS jmlwanita FROM a_jabfungum a
                      LEFT JOIN tb_1223 b ON a.idjabfungum = b.idjabfungum AND b.idjenkedudupeg NOT IN (99,21) and b.idjenjab = '3' and b.idstspeg='3' $where GROUP BY a.jabfungum ORDER BY a.jabfungum");
