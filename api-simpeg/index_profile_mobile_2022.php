<?php
    ...
    a.noskkgb as no_sk_kgb, date_format(a.tgskkgb,'%d-%m-%Y') as tanggal_sk_kgb, date_format(a.tmtkgb,'%d-%m-%Y') as tmt_kgb, a.mkgolthnkgb as masa_tahun_kgb, a.mkgolblnkgb as masa_bulan_kgb,
