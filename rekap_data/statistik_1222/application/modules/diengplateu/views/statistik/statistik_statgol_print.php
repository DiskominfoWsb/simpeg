<html>
<head>
    <title>Simpeg Tegal Statistik Golongan</title>
...
<?php
    ...
    $idgolrupkt = $this->input->post('idgolrupkt');
    $idskpd = $this->input->post('idskpd');

    $where = " where a.idjenkedudupeg not in('99','21') ";
    if($idwhere != "1") {
        $where.=" and a.idgolrupkt = \"".$idgolrupkt."\"";
        $titile_golru = " GOLONGAN ".$this->siemodel->getAttrdata("a_golruang","idgolru",$idgolrupkt,"golru");
    }else{
        $titile_golru = " SEMUA GOLONGAN ";
    }
...
<center>
    ...
    <h3>BERDASARKAN <?php echo $titile_kelamin?> <?php echo strtoupper($titile_golru)?></h3>
</center><br>
<table border="1">
    <colgroup>
