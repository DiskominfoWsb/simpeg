...
<html>
<head>
    <title>Simpeg Tegal Statistik Sekretaris Desa</title>
...
<?php
    ...
    $where = " where a.idjenkedudupeg not in('99','21') AND (a.niplama LIKE '%sekdes%' OR j.jabfungum = 'sekdes') ";
    if($idwhere != "1") {
...
?>
<center>
    <h3>DAFTAR PEGAWAI SEKRETARIS DESA <?php echo $titile_skpd?></h3>
