        ...
        <table class="table table-hover table-bordered" width="100%" id="tb-statistik">
            ...
            <?php
                ...
                <tr>
                    ...
                    <td><div class="text" align="right" data="0" isguru="4" skpd="<?=$this->input->post('idskpd')?>" title="Lihat Detail"><?php echo number_format($item->guru)?></div></td>
                    <td><div class="text" align="right" data="0" isguru="0" skpd="<?=$this->input->post('idskpd')?>" title="Lihat Detail"><?php echo number_format($item->nonguru)?></div></td>
                    <td><div class="text" align="right" data="0" isguru="sum" skpd="<?=$this->input->post('idskpd')?>" title="Lihat Detail"><?php echo number_format($item->guru + $item->nonguru)?></div></td>
                </tr>
                <?php } ?>
                <tr class="breadcrumb">
                    <td colspan="2">Grand Total</td>
                    <td><div class="text" align="right" data="1" isguru="4" skpd="<?=$this->input->post('idskpd')?>" title="Lihat Detail"><?php echo number_format(array_sum($sumguru))?></div></td>
                    <td><div class="text" align="right" data="1" isguru="0" skpd="<?=$this->input->post('idskpd')?>" title="Lihat Detail"><?php echo number_format(array_sum($sumnonguru))?></div></td>
                    <td><div class="text" align="right" data="1" isguru="grand" skpd="<?=$this->input->post('idskpd')?>" title="Lihat Detail"><?php echo number_format(array_sum($jmlall))?></div></td>
                </tr>
            </tbody>
        </table>
    </div>
