...
<html>
<head>
    <title>Simpeg Tegal Statistik Status Guru</title>
...
<?php
    ...
    $iskartu = $this->input->post('iskartu');
    $idskpd = $this->input->post('idskpd');

    $where = " where a.idjenkedudupeg not in('99','21') ";
    if($iskartu == "1") {
        $where.=" and a.nokarpeg != ''";
        $titile_kartu = " YANG MEMILIKI KARPEG ";
    }else if($iskartu == "11") {
        $where.=" and a.nokarpeg = ''";
        $titile_kartu = " YANG TIDAK MEMILIKI KARPEG ";
    }else if($iskartu == "2") {
        $where.=" and a.nokaris != ''";
        $titile_kartu = " YANG MEMILIKI KARIS / KARSU ";
    }else if($iskartu == "22") {
        $where.=" and a.nokaris = ''";
        $titile_kartu = " YANG TIDAK MEMILIKI KARIS / KARSU ";
    }else{
        $titile_kartu = " YANG MEMILIKI KARPEG DAN KARIS / KARSU ";
    }
...
<center>
    ...
    <h3>BERDASARKAN <?php echo $titile_kelamin?> <?php echo strtoupper($titile_kartu)?></h3>
</center><br>
<table border="1">
    <colgroup>
