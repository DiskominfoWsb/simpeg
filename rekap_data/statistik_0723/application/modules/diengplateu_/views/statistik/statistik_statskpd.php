        ...
        <table class="table table-hover table-bordered" width="100%" id="tb-statistik">
            ...
            <?php
                ...
                <tr class="breadcrumb">
                    ...
                    <td><div align="right"><?php echo number_format(array_sum($sumallp))?></div></td>
                    <td><div align="right"><?php echo number_format(array_sum($sumallw))?></div></td>
                    <td><div align="right"><?php echo number_format(array_sum($jmlall))?></div></td>
                </tr>
            </tbody>
        </table>
    </div>
