<?php if(! defined('BASEPATH')) exit('No direct script acess allowed');
    class Siemodel extends CI_Model {
		...
		function getPensiun(){
			$rs = $this->db->query("select count(*) as jml from tb_0723 where idjenkedudupeg in (99,21)")->row();
			return $rs->jml;
		}
        ...
        function listKategori($id="idkategori",$sel="",$required=""){
            ...
            $ret.="<option value='statdikfungsekdes' ".(($sel=='statdikfungsekdes')?'selected':'').">Fungsional Umum Sekdes Perkecamatan</option>";
