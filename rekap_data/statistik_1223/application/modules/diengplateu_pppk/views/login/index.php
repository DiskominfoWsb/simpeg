        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <h2 id="judulapp">DATA STATISTIK PNS PEMKAB. WONOSOBO</h2>
                   <form class="form-inline" role="form" action="<?=base_url()?>diengplateu/auth/login" enctype="multipart/formdata" method="post">
                      <div class="form-group">
                        ...
                        <input type="hidden" value="mimin" class="form-control" id="username" name="username" placeholder="Enter Username" readonly>
                      </div>
                      <div class="form-group">
                        <label class="sr-only" for="password">Password</label>
                        <input type="hidden" value="mimin4321"class="form-control" id="password" name="userpass" placeholder="Password" readonly>
                      </div>
                      
                      <button type="submit" name="login" id="blogin" class="btn btn-link" title="Login">MASUK</button>
                    </form>
                    
                    <p></p>
                    <hr>
                    <p class="copyright">&copy;2014 Pemerintah Kabupaten Wonosobo. Dikembangkan oleh BKD</a></p>
                </div>
            </div>
        </div>
    </div>      
