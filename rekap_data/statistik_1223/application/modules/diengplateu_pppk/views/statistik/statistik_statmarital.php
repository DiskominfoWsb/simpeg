<script>
    $(document).ready(function(){
        $('#tb-statistik .link').click(function(){
            ...
            var vidstskawin = $(par).find('.ed1').html();
            ...
            $('#form-print #idstskawin').val(vidstskawin);
...
<form id="form-print" name="form-print" action="<?=base_url()?>diengplateu/page/statistik_statmarital_print" class="form-horizontal" method="post" enctype="multipart/form-data" target="_blank">
    <input type="hidden" id="idwhere" name="idwhere" value="" />
    <input type="hidden" id="idjenkel" name="idjenkel" value="" />
    <input type="hidden" id="idstskawin" name="idstskawin" value="" />
        ...
        <table class="table table-hover table-bordered" width="100%" id="tb-statistik">
            <thead>
                <tr>
                    ...
                    <th><div align="center">Status Pernikahan</div></th>
            ...
            <?php
                ...
                $rs = $this->db->query("SELECT a.stskawin AS kategori, a.idstskawin, SUM(IF(b.idstskawin!='' AND b.idjenkel = 1,1,0)) AS jmlpria, SUM(IF(b.idstskawin!='' AND b.idjenkel = 2,1,0)) AS jmlwanita FROM a_stskawin a
                      LEFT JOIN tb_1223 b ON a.idstskawin = b.idstskawin AND b.idjenkedudupeg NOT IN (99,21) and b.idstspeg='3' $where GROUP BY a.idstskawin");
                ...
                <tr>
                    <td>
                        <?php echo $x?>
                        <span class="ed1" style="display:none"><?=$item->idstskawin?></span>
                    </td>
