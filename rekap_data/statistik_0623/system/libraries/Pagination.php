...
class CI_Pagination {
	...
	var $last_tag_open		= '&nbsp;';
	var $last_tag_close		= '';
	var $cur_tag_open		= '&nbsp;<a class="paginate_active paginate_button"><strong>';
	var $cur_tag_close		= '</strong></a>';
	var $next_tag_open		= '&nbsp;';
	var $next_tag_close		= '&nbsp;';
	var $prev_tag_open		= '&nbsp;';
	var $prev_tag_close		= '';
	...
	function create_links()
	{
        ...
        {
            $paging_function = 'class="ajax-replace paginate_button"';
        }
        else{
            $paging_function = '';
        }  
		...
		for ($loop = $start -1; $loop <= $end; $loop++)
		{
			...
			if ($i >= 0)
			{
				if ($this->cur_page == $loop)
				{
					if($this->is_ajax_paging == TRUE)
					{
						$paging_function = 'class="ajax-replace current paginate_button"';
					}
					else{
						$paging_function = 'class="current paginate_button paginate_active"';
					}  	
