    ...
    <div class="col-lg-12" id="result-graph">
        <?php
            switch($this->input->post('idkategori')){
                ...
                case "statdikfungsekdes" : $this->load->view('diengplateu/statistik/statistik_statdikfungsekdes_graph'); break;
    ...
    <div class="col-lg-12">
        <?php
            switch($this->input->post('idkategori')){
                ...
                case "statdikfungsekdes" : $this->load->view('diengplateu/statistik/statistik_statdikfungsekdes'); break;
