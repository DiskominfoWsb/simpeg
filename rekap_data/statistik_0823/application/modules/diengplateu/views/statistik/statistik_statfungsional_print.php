...
<html>
<head>
    <title>Simpeg Tegal Statistik Jabatan Fungsional</title>
...
<?php
    ...
    $idjabfung = $this->input->post('idjabfung');
    $idskpd = $this->input->post('idskpd');

    $where = " where a.idjenkedudupeg not in('99','21') and a.idjenjab = 2 and a.idjabfung != ''";
    if($idwhere != "1") {
        $where.=" and e.jabfung = \"".$idjabfung."\"";
        $titile_jabfung = " JABATAN FUNGSIONAL ".$idjabfung;
    }else{
        $titile_jabfung = " SEMUA JABATAN FUNGSIONAL ";
    }
...
<center>
    ...
    <h3>BERDASARKAN <?php echo $titile_kelamin?> <?php echo strtoupper($titile_jabfung)?></h3>
</center><br>
<table border="1">
    <colgroup>
