...
<html>
<head>
    <title>Simpeg Tegal Statistik Diklat Struktural</title>
...
<?php
    ...
    $idstskawin = $this->input->post('idstskawin');
    $idskpd = $this->input->post('idskpd');

    $where = " where a.idjenkedudupeg not in('99','21') ";
    if($idwhere != "1") {
        $where.=" and a.idstskawin = \"".$idstskawin."\"";
        $titile_dikstru = " STATUS PERNIKAHAN ".$this->siemodel->getAttrdata("a_stskawin","idstskawin",$idstskawin,"stskawin");
    }else{
        $titile_dikstru = " SEMUA STATUS PERNIKAHAN ";
    }
...
<center>
    ...
    <h3>BERDASARKAN <?php echo $titile_kelamin?> <?php echo strtoupper($titile_dikstru)?></h3>
</center><br>
<table border="1">
    <colgroup>
