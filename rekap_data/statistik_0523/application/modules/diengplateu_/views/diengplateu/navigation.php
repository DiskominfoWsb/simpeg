            ...
            <div class="navbar-default sidebar" role="navigation">
                ...
                <div id="sidebar-menu" class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> &nbsp; Statistik PNS<span class="fa plus-minus"></span></a>
                            <ul class="nav nav-second-level">
                                ...
                                <li><a href="#">Diklat Fungsional</a></li>
                                <li><a href="<?php echo base_url()?>diengplateu/page/statistik/statdikfungjenjab">Fungsional Umum Per Jenis Jabatan</a></li>
                                <!--<li><a href="<?php /*echo base_url()*/?>diengplateu/page/statistik/statdikfungsekdes">Fungsional Umum Sekdes Perkecamatan</a></li>-->
                                <li><a href="#">Fungsional Umum Sekdes Perkecamatan</a></li>
                        ...
                        <!--<li class="sidebar-search"><strong>Statistik Khusus</strong></li>
                        <li>
